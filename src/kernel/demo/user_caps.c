 ...
 *              versioned seed block, stdout capability write, waitable handle
 *              wait/close, stale-handle rejection after close, and the
...
enum
{
    ...
    KI_USER_CAPS_WAIT_TIMEOUT_MS = 250U,
};
...
static const uint8_t gKiUserCapsCodeBytes[] = {
    ...
    // rejection, wait on the seeded waitable handle, close it, and then exit
    // through the unchanged raw bootstrap exit path.
    0xB9, KI_U32_LE_BYTES((uint32_t)EX_USER_BRINGUP_P1_MAILBOX_ADDRESS),
    0x8B, 0x01,
    0x3D, KI_U32_LE_BYTES(EX_USER_BRINGUP_P1_MAILBOX_GATE_OPEN),
    0x75, 0xF7,

    0xB9, KI_U32_LE_BYTES((uint32_t)EX_USER_IMAGE_CONST_BASE),
    0x8B, 0x01,
    0x3D, KI_U32_LE_BYTES(EX_USER_CAPABILITY_SEED_VERSION),
    0x0F, 0x85, KI_U32_LE_BYTES(218U),
    0x8B, 0x41, EX_USER_CAPABILITY_SEED_SIZE_OFFSET,
    0x3D, KI_U32_LE_BYTES(EX_USER_CAPABILITY_SEED_BLOCK_SIZE),
    0x0F, 0x85, KI_U32_LE_BYTES(204U),
    0x8B, 0x41, EX_USER_CAPABILITY_PROCESS_SELF_OFFSET,
    0x85, 0xC0,
    0x0F, 0x84, KI_U32_LE_BYTES(193U),
    0x8B, 0x41, EX_USER_CAPABILITY_THREAD_SELF_OFFSET,
    0x85, 0xC0,
    0x0F, 0x84, KI_U32_LE_BYTES(182U),
    0x8B, 0x41, EX_USER_CAPABILITY_STDOUT_OFFSET,
    0x85, 0xC0,
    0x0F, 0x84, KI_U32_LE_BYTES(171U),
    0x8B, 0x41, EX_USER_CAPABILITY_WAIT_OBJECT_OFFSET,
    0x85, 0xC0,
    0x0F, 0x84, KI_U32_LE_BYTES(160U),

    0xB8, KI_U32_LE_BYTES(EX_USER_SYS_WRITE),
    0x8B, 0x79, EX_USER_CAPABILITY_STDOUT_OFFSET,
    0xBE, KI_U32_LE_BYTES((uint32_t)(EX_USER_IMAGE_CONST_BASE + KI_USER_CAPS_PAYLOAD_MESSAGE_OFFSET)),
    0xBA, KI_U32_LE_BYTES(KI_USER_CAPS_PAYLOAD_MESSAGE_LENGTH),
    0xCD, EX_USER_SYSCALL_VECTOR,
    0x3D, KI_U32_LE_BYTES(KI_USER_CAPS_PAYLOAD_MESSAGE_LENGTH),
    0x0F, 0x85, KI_U32_LE_BYTES(129U),

    0xB9, KI_U32_LE_BYTES((uint32_t)EX_USER_IMAGE_CONST_BASE),
    0xB8, KI_U32_LE_BYTES(EX_USER_SYS_CLOSE),
    0x8B, 0x79, EX_USER_CAPABILITY_STDOUT_OFFSET,
    0x31, 0xF6,
    0x31, 0xD2,
    0xCD, EX_USER_SYSCALL_VECTOR,
    0x85, 0xC0,
    0x0F, 0x85, KI_U32_LE_BYTES(102U),
    ...
    0x0F, 0x85, KI_U32_LE_BYTES(66U),

    0xB9, KI_U32_LE_BYTES((uint32_t)EX_USER_IMAGE_CONST_BASE),
    0xB8, KI_U32_LE_BYTES(EX_USER_SYS_WAIT_ONE),
    0x8B, 0x79, EX_USER_CAPABILITY_WAIT_OBJECT_OFFSET,
    0xBE, KI_U32_LE_BYTES(KI_USER_CAPS_WAIT_TIMEOUT_MS),
    0x31, 0xD2,
    0xCD, EX_USER_SYSCALL_VECTOR,
    0x85, 0xC0,
    0x0F, 0x85, KI_U32_LE_BYTES(36U),
    ...
    0xB8, KI_U32_LE_BYTES(EX_USER_BRINGUP_SYS_RAW_EXIT),
    0x31, 0xFF,
    0xCD, EX_USER_SYSCALL_VECTOR,
    0x0F, 0x0B,
};
...
RunUserCapsDemo(void)
{
    ...
    EX_BOOTSTRAP_THREAD_CREATE_PARAMS threadParams = {
        ...
        .EntryArg = NULL,
        .Flags = EX_BOOTSTRAP_THREAD_CREATE_FLAG_SEED_WAIT_OBJECT,
    };
