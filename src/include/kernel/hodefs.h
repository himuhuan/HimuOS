...
#define KRNL_IST2_STACK_VA (KRNL_IST1_STACK_VA + HO_STACK_SIZE + PAGE_4KB)                  // Kernel IST2 stack BOTTOM virtual address
#define HHDM_BASE_VA       0xFFFF900000000000ULL                                            // HHDM (Higher Half Direct Mapping) base virtual address
#define MMIO_BASE_VA       0xFFFFC00000000000ULL                                            // MMIO base virtual address
