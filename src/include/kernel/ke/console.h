...
#ifndef HO_ENABLE_CONSOLE_LIGHT_THEME
#define HO_ENABLE_CONSOLE_LIGHT_THEME 0
#endif

#if HO_ENABLE_CONSOLE_LIGHT_THEME
#define HO_CONSOLE_DEFAULT_FOREGROUND COLOR_BLACK
#define HO_CONSOLE_DEFAULT_BACKGROUND COLOR_WHITE
#else
#define HO_CONSOLE_DEFAULT_FOREGROUND COLOR_TEXT
#define HO_CONSOLE_DEFAULT_BACKGROUND COLOR_BLACK
#endif
