 ...
 * Description: Runtime-scoped Ex process wrapper and create parameters.
...
/* Opaque owning handle for runtime process staging until transferred. */
typedef struct EX_PROCESS EX_PROCESS;

#define EX_MAX_PROCESSES           8u
#define EX_MAX_THREADS_PER_PROCESS 1u

typedef struct EX_RUNTIME_PROCESS_CREATE_PARAMS
{
...
} EX_RUNTIME_PROCESS_CREATE_PARAMS;
