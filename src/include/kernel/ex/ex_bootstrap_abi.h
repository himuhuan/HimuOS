...
#define SYS_SPAWN_PROGRAM                                (KE_USER_BOOTSTRAP_CAPABILITY_SYSCALL_BASE + 5U)
...
#define KE_USER_BOOTSTRAP_LOG_SPAWN_PROGRAM_SUCCEEDED  "[DEMOSHELL] SYS_SPAWN_PROGRAM succeeded"
#define KE_USER_BOOTSTRAP_LOG_SPAWN_PROGRAM_REJECTED   "[DEMOSHELL] SYS_SPAWN_PROGRAM rejected"
