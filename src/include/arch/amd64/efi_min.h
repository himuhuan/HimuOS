 ...
 * File: efi_min.h
 * Description:
 * Minimal EFI-related definitions for AMD64 architecture.
 *
...
// NOTE: EFI standard tells us the BOOL only has 1 byte size, but 'BOOL' typedefs in Windows is 4 bytes.
typedef BYTE BOOL;
